...
/* the number of tuples we are going to count */
/* tuples ~ variables ~ dimensions */
unsigned int num_tuples = 2; 

/* range specifications for each tuple */

/* there are $num_tuples rows, and each row
 * contains however many ranges
 */
unsigned int *rangespec[2];
rangespec[0] = {0, 200, 300, 500, UINT_MAX};
rangespec[1] = {0, 90, 100, UINT_MAX};
